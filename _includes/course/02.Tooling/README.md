...
| ![Using numpy and matplotlib with Colab](images/02.Tooling/colab-matplotlib.png) | 
|:--:| 
...
| ![TensorFlow playground](images/02.Tooling/tensorflow-playground.png) | 
|:--:| 
...
| ![TensorFlow projector](images/02.Tooling/tensorflow-projector.png) | 
|:--:| 
...
| ![What-If Tool](images/02.Tooling/what-if-tool.gif) | 
|:--:| 
...
| ![Teachable machine](images/02.Tooling/teachable-machine.png) | 
|:--:| 
...
| ![Cloud TPU Pod v3](images/02.Tooling/google-cloud-ai.png) | 
|:--:| 
...
| ![Systolic array architecture](images/02.Tooling/Systolic_Array_for_Neural_Network_2g8b7.gif) | 
|:--:| 
